...
portal_cinnamon_style_install () {

	echo
	echo
	echo "##"
	echo "## ## portal_cinnamon_style_install"
	echo "##"
	echo
	echo

	mod_cinnamon_style_install_prerun

	mod_cinnamon_style_install_mainrun

	mod_cinnamon_style_install_postrun
